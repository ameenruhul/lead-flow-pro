  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-glow hover:shadow-[0_0_60px_hsl(221_83%_53%_/_0.3)] hover:-translate-y-1 font-semibold",
        "hero-outline": "border-2 border-foreground/20 bg-background/50 backdrop-blur-sm text-foreground hover:bg-background/80 hover:border-foreground/30",
        glass: "bg-card/70 backdrop-blur-xl border border-white/50 text-foreground hover:bg-card/90 shadow-card",
      },
      size: {
